...
export function ReportsClient({ reports }: { reports: ReportRow[] }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      >
        <div className={cn(lab.panel, "grid gap-3 sm:grid-cols-[200px_1fr_auto] sm:items-end")}>
      ...
      <LabSection title="Laporan" description={`${reports.length} laporan.`}>
        {reports.length === 0 ? (
          <LabEmptyState
            icon={FileText}
          ...
          <div className="flex flex-col gap-2">
            {reports.map((r) => {
              ...
              return (
                <div key={r.id} className={cn(lab.card, "flex items-center gap-3 p-3")}>
