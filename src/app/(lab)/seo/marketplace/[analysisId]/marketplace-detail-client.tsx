      ...
      {busy ? (
        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-wrap gap-3">
            <LabStatChip label="Listing" value={num(s.count)} tone="accent" />
            <LabStatChip label="Harga median" value={rupiah(s.medianPrice)} />
            <LabStatChip label="Rating rata-rata" value={num(s.avgRating)} tone="success" />
            <LabStatChip label="Total terjual" value={num(s.totalSold)} />
            <LabStatChip
              label="Official shop"
              value={
            ...
            />
            <LabStatChip label="Panjang judul" value={num(s.avgTitleLength)} />
          </div>
          ...
          {recs?.recommendations && recs.recommendations.length > 0 ? (
            <div className={lab.panel}>
              <p className={cn(lab.label, "mb-2")}>Rekomendasi</p>
          ...
          <div className="grid gap-5 lg:grid-cols-[280px_1fr]">
            <div className={cn(lab.card, "h-fit p-4")}>
