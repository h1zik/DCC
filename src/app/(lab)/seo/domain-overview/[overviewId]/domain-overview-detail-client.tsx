        ...
        <>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className={cn(lab.card, "p-4")}>
              <p className={cn(lab.label, "mb-1")}>Estimasi trafik organik</p>
            ...
            <div className={cn(lab.card, "p-4")}>
              <p className={cn(lab.label, "mb-1")}>Keyword organik</p>
              <p className="text-3xl font-bold tabular-nums">
                {num(detail.overview?.organicKeywords)}
              </p>
            </div>
            <div className={cn(lab.card, "p-4")}>
              <p className={cn(lab.label, "mb-1")}>Keyword iklan (paid)</p>
              <p className="text-3xl font-bold tabular-nums">
