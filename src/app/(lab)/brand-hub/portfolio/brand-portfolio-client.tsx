...
export function BrandPortfolioClient({
  ...
  if (!brandId) {
    return (
      <div className={cn(lab.panel, "p-6 text-sm text-muted-foreground")}>
  ...
  return (
    <div className={cn("flex flex-col gap-5", lab.entrance)}>
      <div className={cn(lab.panel, "flex flex-wrap items-center justify-between gap-3 p-4")}>
        <div>
      ...
      <section className={cn(lab.panel, "grid gap-4 p-4")}>
        <div className="flex items-center gap-2">
          <Layers className="text-[var(--lab-accent,var(--primary))] size-4" />
      ...
      <section className="flex flex-col gap-3">
        ...
        {lines.map((line, index) => (
          <article
            ...
            className={cn(lab.panel, "grid gap-4 p-4 md:grid-cols-2")}
          >
