...
export function ContentClient({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ResearchHubSection title="Brief" description={`${briefs.length} brief.`}>
        {briefs.length === 0 ? (
          <ResearchHubEmptyState
            icon={FileText}
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {briefs.map((b) => (
              <div key={b.id} className={cn(hub.card, "flex flex-col gap-2 p-4")}>
      ...
      <ResearchHubSection title="Draft" description={`${drafts.length} draft.`}>
        {drafts.length === 0 ? (
          <ResearchHubEmptyState
            icon={PenLine}
          ...
          <div className="flex flex-col gap-2">
            {drafts.map((d) => (
              <div key={d.id} className={cn(hub.card, "flex items-center gap-3 p-3")}>
                <div
                  className={cn(
