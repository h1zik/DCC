...
import { ResearchHubSection, hub } from "@/components/research-hub/research-hub-primitives";
...
export function CrawlScheduleSection({
  ...
  return (
    ...
    >
      <div className={cn(hub.panel, "grid gap-3 sm:grid-cols-[1fr_180px_auto] sm:items-end")}>
      ...
      {schedules.length > 0 ? (
        <div className="flex flex-col gap-2">
          {schedules.map((s) => (
            <div key={s.id} className={cn(hub.card, "flex items-center gap-3 p-3")}>
