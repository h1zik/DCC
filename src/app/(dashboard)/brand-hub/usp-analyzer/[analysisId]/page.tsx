...
import { parseStoredContextModules } from "@/lib/brand-research/list-context-sources";
import { normalizePositioningMap } from "@/lib/research/usp-gap/positioning-chart";
import {
  BrandUspDetailClient,
  type UspDetailData,
} from "./brand-usp-detail-client";
...
export default async function UspAnalyzerDetailPage({
  ...
  return (
    <div className="flex w-full flex-col gap-6 pb-6">
      <BrandUspDetailClient data={data} />
    </div>
  );
}
