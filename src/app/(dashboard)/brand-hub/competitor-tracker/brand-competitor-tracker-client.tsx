...
export function BrandCompetitorTrackerClient({
  ...
  function handleCreate() {
    startTransition(async () => {
      try {
        const result = await createBrandCompetitor({
          name,
          brand,
          category,
          marketplace,
        ...
        setCategory("");
        setShopUrl("");
        router.push(`/brand-hub/competitor-tracker/${result.id}`);
      } catch (err) {
              ...
              <div className="mt-3 flex justify-end gap-1 border-t pt-3">
                <Button
                  ...
                  onClick={() =>
                    startTransition(async () => {
                      try {
                        await refreshBrandCompetitor(c.id);
                ...
                <Button
                  ...
                  onClick={() =>
                    startTransition(async () => {
                      ...
                      try {
                        await deleteBrandCompetitor(c.id);
