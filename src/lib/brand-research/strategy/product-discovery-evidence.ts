...
function pickInsights(raw: unknown): Omit<ProductDiscoveryEvidence, "sourceId" | "keyword" | "productCount" | "marketplaces"> {
  ...
  const priceStats =
    o.priceStats && typeof o.priceStats === "object"
      ...
      : null;
  const velocity = o.velocity as { topSellers?: { name?: string; sold?: number; price?: number }[] } | undefined;
