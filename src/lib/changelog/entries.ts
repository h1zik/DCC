...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      "Seret tile untuk mengatur posisi post secara manual; tombol Reset mengembalikan ke urutan tanggal & jam posting",
      "Tambah atau keluarkan post dari feed: tombol X di tile (saat hover) mengeluarkan, panel Di luar feed memasukkan kembali, tombol Baris baru membuat konten baru",
      ...
      "Aturan otomatis untuk baris yang belum diatur manual: arsip, platform non-Instagram, dan baris tanpa tanggal bisa disertakan atau tidak",
