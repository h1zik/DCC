  ...
  return (
    <p
      className={cn(
        ...
        isFailed && "border-rose-500/40 bg-rose-500/10 text-rose-800 dark:text-rose-200",
        isPartial && "border-amber-500/40 bg-amber-500/10 text-amber-900 dark:text-amber-100",
