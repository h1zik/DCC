  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // `grid` items default to min-width:auto — konten intrinsik lebar
          // (select dengan opsi panjang, URL) melebarkan track dan bikin dialog
          // scroll horizontal. `[&>*]:min-w-0` mengunci lebar track ke popup.
